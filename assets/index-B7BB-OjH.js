...
turtle.done()`,hints:["用 `colors[i % 5]` 可以让颜色循环使用（i 除以 5 的余数取 0~4）","步数用 `i * 5` 会让每次走的距离越来越大",`转角试试 59、60、89、91，看看画出来的图案有什么不一样？`],checks:[{description:`代码里有 import turtle`,type:`contains`,value:`import turtle`},{description:`代码里有 turtle.color`,type:`contains`,value:`color(`},{description:`代码里有 for 循环`,type:`contains`,value:`for `},{description:`代码可以正常运行`,type:`no_error`}]}],E=[{id:`l3_9`,title:`第9课：猜数字游戏`,series:`main`,difficulty:3,prerequisites:[`l2_6`],estimatedTime:25,objectives:[`理解 if/else 条件判断`,`学会使用比较运算符（>, <, ==）`,`做出一个猜数字小游戏`],content:{intro:`之前我们学的代码，计算机都是"照做"就行——你说什么它做什么。
...
if player == computer:
    ...
    print("请输入 石头、剪刀 或 布！")`,hints:['用 `random.choice(["石头", "剪刀", "布"])` 让计算机随机选一个',"先判断 `player == computer` → 平局",`然后分"石头""剪刀""布"三种情况，每种里面再判断计算机出什么`],checks:[{description:`代码里有 import random`,type:`contains`,value:`import random`},{description:`代码里有 if 判断`,type:`contains`,value:`if `},{description:`代码里有 input()`,type:`contains`,value:`input(`},{description:`代码可以正常运行`,type:`no_error`}]}],D=[{id:`l4_13`,title:`第13课：购物清单`,series:`main`,difficulty:4,prerequisites:[`l3_10`],estimatedTime:25,objectives:[`认识列表——一个能装很多东西的"大盒子"`,`学会用 append() 往列表里添加东西`,`用 for 循环遍历列表里的每一项`],content:{intro:`你有没有跟妈妈一起去超市买过东西？
...
`},{description:`代码可以正常运行`,type:`no_error`}]}],k=[{id:`l6_21`,title:`第21课：代码侦探`,series:`main`,difficulty:6,prerequisites:[`l5_20`],estimatedTime:25,objectives:[`读懂别人写的代码，找到缺失的部分`,`综合运用变量、for 循环和 if 判断`,`完成第一个 L6 综合挑战`],content:{intro:`L6 综合挑战开始了！🏆
...
if choice in shop:
    ...
    print("本店没有这个道具哦～")`,hints:["用 `for item, price in shop.items():` 同时遍历键和值","用 `if choice in shop:` 判断用户输入的商品是否存在","折扣用 `random.randint(1, 9) / 10` 生成 0.1~0.9 的随机折扣"],checks:[{description:`代码里有 import random`,type:`contains`,value:`import random`},{description:`代码里有字典`,type:`contains`,value:`{`},{description:`代码里有 input()`,type:`contains`,value:`input(`},{description:`代码里有 if 判断`,type:`contains`,value:`if `},{description:`代码不超过 20 行（不含空行）`,type:`max_lines`,value:20},{description:`代码可以正常运行`,type:`no_error`}]}],M=[...w,...T,...E,...D,...O,...k,...A,...j];function te(e){return M.find(t=>t.id===e)}function ne(e){let t=M.findIndex(t=>t.id===e);if(!(t===-1||t>=M.length-1))return M[t+1]}function re(e){let t=M.findIndex(t=>t.id===e);if(!(t<=0))return M[t-1]}var ie={};M.forEach(e=>{e.series===`main`&&(ie[e.difficulty]??=[]).push(e.id)});var N=[{id:`first_run`,name:`初次运行`,icon:`▶️`,description:`第一次运行 Python 代码`,category:`course`,check:e=>Object.keys(e.completedLessons).length>0},{id:`first_print`,name:`开口说话`,icon:`🗣️`,description:`使用 print() 输出文字`,category:`course`,check:e=>Object.keys(e.completedLessons).length>0},{id:`first_math`,name:`小小数学家`,icon:`🧮`,description:`使用 Python 做数学运算`,category:`course`,check:e=>e.completedLessons.l1_3?.completed??!1},{id:`first_var`,name:`记忆大师`,icon:`📦`,description:`创建和使用变量`,category:`course`,check:e=>e.completedLessons.l1_4?.completed??!1},{id:`complete_l1`,name:`初学者`,icon:`🌱`,description:`完成 L1 全部课程`,category:`course`,check:e=>P(e,1)},{id:`complete_l2`,name:`循环大师`,icon:`🔄`,description:`完成 L2 全部课程`,category:`course`,check:e=>P(e,2)},{id:`complete_l3`,name:`逻辑达人`,icon:`🧠`,description:`完成 L3 全部课程`,category:`course`,check:e=>P(e,3)},{id:`complete_l4`,name:`数据专家`,icon:`📊`,description:`完成 L4 全部课程`,category:`course`,check:e=>P(e,4)},{id:`complete_l5`,name:`函数大师`,icon:`🎩`,description:`完成 L5 全部课程`,category:`course`,check:e=>P(e,5)},{id:`complete_l6`,name:`综合挑战者`,icon:`🏆`,description:`完成 L6 全部课程`,category:`course`,check:e=>P(e,6)},{id:`l6_all_stars`,name:`挑战满分`,icon:`💫`,description:`L6 全部课程拿到 3 颗星`,category:`course`,check:e=>ae(e,6)},{id:`all_stars`,name:`完美通关`,icon:`🌟`,description:`所有课程都拿到 3 颗星`,category:`course`,check:e=>{let t=Object.values(e.completedLessons).filter(e=>e.completed);return t.length<M.length?!1:t.every(e=>e.stars>=3)}},{id:`typing_first`,name:`初识键盘`,icon:`⌨️`,description:`完成第一次打字练习`,category:`typing`,check:e=>e.typingStats.records.length>=1},{id:`typing_10_sessions`,name:`坚持不懈`,icon:`📅`,description:`累计完成 10 次打字练习`,category:`typing`,check:e=>e.typingStats.records.length>=10},{id:`typing_streak_7`,name:`天天向上`,icon:`🔥`,description:`连续 7 天练习打字`,category:`typing`,check:e=>e.typingStats.currentStreak>=7},{id:`typing_wpm_20`,name:`键盘小飞手`,icon:`💨`,description:`最快速度达到 20 WPM`,category:`typing`,check:e=>e.typingStats.bestWpm>=20},{id:`typing_accuracy_95`,name:`一丝不苟`,icon:`🎯`,description:`单次练习准确率达到 95%`,category:`typing`,check:e=>e.typingStats.bestAccuracy>=.95},{id:`typing_combo_30`,name:`连击大师`,icon:`✨`,description:`达成单次 30 连击`,category:`typing`,check:e=>e.typingStats.bestCombo>=30},{id:`typing_level_5`,name:`闪电打字员`,icon:`⚡`,description:`打字等级达到 5 级`,category:`typing`,check:e=>e.typingStats.level>=5},{id:`typing_1000_score`,name:`积分破千`,icon:`💰`,description:`累计打字积分超过 1000`,category:`typing`,check:e=>e.typingStats.totalScore>=1e3},{id:`typing_perfect`,name:`又快又准`,icon:`💎`,description:`准确率 95% 且速度达到 20 WPM`,category:`typing`,check:e=>e.typingStats.bestAccuracy>=.95&&e.typingStats.bestWpm>=20}];function P(e,t){let n=ie[t];return!n||n.length===0?!1:n.every(t=>e.completedLessons[t]?.completed)}function ae(e,t){let n=ie[t];return!n||n.length===0?!1:n.every(t=>(e.completedLessons[t]?.stars??0)>=3)}function oe(e){return N.filter(t=>t.check(e)).map(e=>e.id)}var se={totalScore:0,totalPracticeTime:0,totalKeystrokes:0,bestWpm:0,bestAccuracy:0,bestCombo:0,currentStreak:0,lastPracticeDate:``,records:[],level:1},ce={completedLessons:{},unlockedBadges:[],totalStars:0,typingStats:se};function F(){let[e,t]=C(`progress`,ce);return{progress:e,getLessonProgress:(0,_.useCallback)(t=>e.completedLessons[t],[e]),completeLesson:(0,_.useCallback)((e,n,r)=>{t(t=>{let i=t.completedLessons[e],a=i?.stars??0,o=Math.max(a,n),s={lessonId:e,completed:!0,stars:o,attempts:(i?.attempts??0)+1,lastCode:r},c=t.totalStars-a+o,l={...t,completedLessons:{...t.completedLessons,[e]:s},totalStars:c},u=oe(l),d=[...new Set([...t.unlockedBadges,...u])];return{...l,unlockedBadges:d}})},[t]),saveCode:(0,_.useCallback)((e,n)=>{t(t=>{let r=t.completedLessons[e];return{...t,completedLessons:{...t.completedLessons,[e]:{lessonId:e,completed:r?.completed??!1,stars:r?.stars??0,attempts:(r?.attempts??0)+1,lastCode:n}}}})},[t]),canAccess:(0,_.useCallback)(t=>t.length===0?!0:t.every(t=>e.completedLessons[t]?.completed),[e]),getSeriesProgress:(0,_.useCallback)((t,n)=>{let r=t===`main`?`l`:t,i=Object.values(e.completedLessons).filter(e=>e.lessonId.startsWith(r)&&e.completed).length;return n>0?Math.round(i/n*100):0},[e]),addTypingRecord:(0,_.useCallback)(e=>{t(t=>{let n=t.typingStats??se,r=new Date().toISOString().slice(0,10),i=new Date(Date.now()-864e5).toISOString().slice(0,10),a=n.currentStreak;n.lastPracticeDate===r||(a=n.lastPracticeDate===i?n.currentStreak+1:1);let o={totalScore:n.totalScore+e.score,totalPracticeTime:n.totalPracticeTime+e.duration,totalKeystrokes:n.totalKeystrokes+e.totalKeystrokes,bestWpm:Math.max(n.bestWpm,e.wpm),bestAccuracy:Math.max(n.bestAccuracy,e.accuracy),bestCombo:Math.max(n.bestCombo,e.maxCombo),currentStreak:a,lastPracticeDate:r,records:[e,...n.records??[]].slice(0,50),level:n.level};o.level=ue(o.totalScore);let s=de(o),c=[...new Set([...t.unlockedBadges,...s])],l=t.totalStars+e.stars;return{...t,typingStats:o,unlockedBadges:c,totalStars:l}})},[t]),resetProgress:(0,_.useCallback)(()=>{t(ce)},[t])}}var le=[{minScore:0,level:1},{minScore:100,level:2},{minScore:300,level:3},{minScore:800,level:4},{minScore:2e3,level:5},{minScore:5e3,level:6},{minScore:12e3,level:7},{minScore:3e4,level:8}];function ue(e){let t=1;for(let n of le)e>=n.minScore&&(t=n.level);return t}function de(e){let t=[];return e.records.length>=1&&t.push(`typing_first`),e.records.length>=10&&t.push(`typing_10_sessions`),e.currentStreak>=7&&t.push(`typing_streak_7`),e.bestWpm>=20&&t.push(`typing_wpm_20`),e.bestAccuracy>=.95&&t.push(`typing_accuracy_95`),e.bestCombo>=30&&t.push(`typing_combo_30`),e.bestAccuracy>=.95&&e.bestWpm>=20&&t.push(`typing_perfect`),e.level>=5&&t.push(`typing_level_5`),e.totalScore>=1e3&&t.push(`typing_1000_score`),t}var I={home:`_home_1x42j_1`,hero:`_hero_1x42j_5`,heroContent:`_heroContent_1x42j_14`,heroTitle:`_heroTitle_1x42j_18`,heroEmoji:`_heroEmoji_1x42j_26`,heroSubtitle:`_heroSubtitle_1x42j_32`,heroDesc:`_heroDesc_1x42j_39`,heroActions:`_heroActions_1x42j_46`,btnPrimary:`_btnPrimary_1x42j_53`,progressSummary:`_progressSummary_1x42j_74`,features:`_features_1x42j_81`,featureCard:`_featureCard_1x42j_90`,featureIcon:`_featureIcon_1x42j_104`,quickStart:`_quickStart_1x42j_123`};function fe(){let{progress:e}=F();return(0,b.jsxs)(`div`,{className:I.home,children:[(0,b.jsx)(`section`,{className:I.hero,children:(0,b.jsxs)(`div`,{className:I.heroContent,children:[(0,b.jsxs)(`h1`,{className:I.heroTitle,children:[(0,b.jsx)(`span`,{className:I.heroEmoji,children:`🐍`}),`欢迎来到 HiPython！`]}),(0,b.jsx)(`p`,{className:I.heroSubtitle,children:`和 Python 小蛇一起，开启编程冒险之旅 🚀`}),(0,b.jsxs)(`p`,{className:I.heroDesc,children:[`用真正的 Python 代码，做出有趣的小项目。`,(0,b.jsx)(`br`,{}),`一步一步来，你会发现编程超好玩！`]}),(0,b.jsxs)(`div`,{className:I.heroActions,children:[(0,b.jsx)(d,{to:`/course-map`,className:I.btnPrimary,children:`🗺️ 开始学习`}),e.totalStars>0&&(0,b.jsxs)(`div`,{className:I.progressSummary,children:[`⭐ `,e.totalStars,` 颗星星已获得`]})]})]})}),(0,b.jsxs)(`section`,{className:I.features,children:[(0,b.jsxs)(`div`,{className:I.featureCard,children:[(0,b.jsx)(`span`,{className:I.featureIcon,children:`📝`}),(0,b.jsx)(`h3`,{children:`真实 Python 代码`}),(0,b.jsx)(`p`,{children:`不是拖积木块，而是打真正的 Python 代码。就像真正的程序员那样！`})]}),(0,b.jsxs)(`div`,{className:I.featureCard,children:[(0,b.jsx)(`span`,{className:I.featureIcon,children:`▶️`}),(0,b.jsx)(`h3`,{children:`即时运行`}),(0,b.jsx)(`p`,{children:`写完代码，点一下运行按钮，马上就能看到结果。`})]}),(0,b.jsxs)(`div`,{className:I.featureCard,children:[(0,b.jsx)(`span`,{className:I.featureIcon,children:`🏆`}),(0,b.jsx)(`h3`,{children:`闯关收集星星`}),(0,b.jsx)(`p`,{children:`每完成一课都能获得星星，集齐所有星星成为 Python 大师！`})]}),(0,b.jsxs)(`div`,{className:I.featureCard,children:[(0,b.jsx)(`span`,{className:I.featureIcon,children:`🎨`}),(0,b.jsx)(`h3`,{children:`作品展览`}),(0,b.jsx)(`p`,{children:`每一课都能做出一个有趣的小作品：计算器、猜数字、画图形…`})]})]}),(0,b.jsxs)(`section`,{className:I.quickStart,children:[(0,b.jsx)(`h2`,{children:`🚀 快速开始`}),(0,b.jsx)(`p`,{children:`第一课只要 20 分钟，试试看？`}),(0,b.jsx)(d,{to:`/lesson/l1_1`,className:I.btnPrimary,children:`📖 第1课：你好，世界！`})]})]})}var pe=[{pattern:/NameError: name '(\w+)' is not defined/,getMessage:e=>`🤔 咦？\`${e[1]}\` 还没有被定义过哦！\n先给它一个值吧，比如：\`${e[1]} = "你好"\``},{pattern:/SyntaxError: unexpected EOF while parsing/,getMessage:()=>`📝 好像少了点什么…检查一下你的括号、引号是不是都配对了？`},{pattern:/SyntaxError: invalid syntax/,getMessage:()=>`📝 语法有点小问题！常见的可能是：
• 少了冒号 \`:\`
• 括号没配对
...
for k in list(globals().keys()):
    if k not in _keep:
        del globals()[k]
`)}function ke(e){e.runPython(ge)}function Ae(e){try{e.runPython(`
import json
try:
    __turtle_json = json.dumps(_commands)
except:
    __turtle_json = '[]'
`);let t=e.globals.get(`__turtle_json`);return t?JSON.parse(t).map(e=>{let t={type:e[0]};return e.length===2?t.value=e[1]:e.length>=3&&e[0]===`goto`&&(t.value=[e[1],e[2]]),t}):[]}catch{return[]}}function je(e){let t={},n=new Set(`__name__.__doc__.__package__.__loader__.__spec__.__builtins__._keep.abs.all.any.ascii.bin.bool.breakpoint.bytearray.bytes.callable.chr.classmethod.compile.complex.copyright.credits.delattr.dict.dir.divmod.enumerate.eval.exec.exit.filter.float.format.frozenset.getattr.globals.hasattr.hash.help.hex.id.input.int.isinstance.issubclass.iter.len.license.list.locals.map.max.memoryview.min.next.object.oct.open.ord.pow.print.property.quit.range.repr.reversed.round.set.setattr.slice.sorted.staticmethod.str.sum.super.tuple.type.vars.zip.sys.math.js.pyodide.turtle.forward.backward.left.right.penup.pendown.color.speed.circle.goto.setheading.home.clear.reset.done._TurtlePen._turtle_module._default_turtle.types`.split(`.`));try{let r=e.globals.toJs({dict_converter:Object.fromEntries});for(let[e,i]of Object.entries(r))n.has(e)||e.startsWith(`_`)||(t[e]=Me(e,i))}catch{}return t}function Me(e,t){if(t==null)return{name:e,type:`NoneType`,value:`None`};if(typeof t==`string`)return{name:e,type:`str`,value:`"${t}"`};if(typeof t==`number`)return{name:e,type:Number.isInteger(t)?`int`:`float`,value:String(t)};if(typeof t==`boolean`)return{name:e,type:`bool`,value:t?`True`:`False`};if(Array.isArray(t)){let n=t.slice(0,5).map(e=>Ne(e)).join(`, `),r=t.length>5?`, ...`:``;return{name:e,type:`list[${t.length}]`,value:`[${n}${r}]`}}if(typeof t==`object`)try{let n=Object.keys(t),r=n.slice(0,3).join(`, `),i=n.length>3?`, ...`:``;return{name:e,type:`dict[${n.length}]`,value:`{${r}${i}}`}}catch{return{name:e,type:`object`,value:String(t).slice(0,50)}}return{name:e,type:typeof t,value:String(t).slice(0,50)}}function Ne(e){return e==null?`None`:typeof e==`string`?`"${e}"`:typeof e==`boolean`?e?`True`:`False`:String(e)}async function Pe(e){let t=await De(),n=``,r=``;t.setStdout({batched:e=>{n+=e+`
`}}),t.setStderr({batched:e=>{r+=e+`
`}});try{return Oe(t),ke(t),await t.runPythonAsync(e),{stdout:(n+r).trim(),error:null,rawError:null,success:!0,turtleCommands:Ae(t),variables:je(t)}}catch(e){let i=e instanceof Error?e.message:String(e),a=(n+r).trim(),o=Ae(t),s=je(t);return{stdout:a,error:me(e instanceof Error?e:i),rawError:i,success:!1,turtleCommands:o,variables:s}}}function Fe(){return xe!==null}function Ie(){return Se}function Le(){let[e,t]=(0,_.useState)(Fe),[n,r]=(0,_.useState)(Ie),[i,a]=(0,_.useState)(``),o=(0,_.useRef)(!1);(0,_.useEffect)(()=>{let e=Te((e,t)=>{r(e),t&&a(t)});return t(Fe()),r(Ie()),e},[]);let s=(0,_.useCallback)(async()=>{if(!(o.current||Fe())){o.current=!0;try{await De(),t(!0),r(!1)}finally{o.current=!1}}},[]);return{isReady:e,isLoading:n,loadingMessage:i,runPython:(0,_.useCallback)(async e=>(Fe()||(await De(),t(!0)),Pe(e)),[]),load:s}}var L={runButton:`_runButton_rpckh_1`,icon:`_icon_rpckh_38`,label:`_label_rpckh_42`,spinner:`_spinner_rpckh_46`,spin:`_spin_rpckh_46`};function Re({onClick:e,disabled:t,loading:n}){return n?(0,b.jsxs)(`button`,{className:L.runButton,disabled:!0,children:[(0,b.jsx)(`span`,{className:L.spinner,children:`⏳`}),(0,b.jsx)(`span`,{className:L.label,children:`加载中…`})]}):(0,b.jsxs)(`button`,{className:L.runButton,onClick:e,disabled:t,title:`运行代码 (Ctrl+Enter)`,children:[(0,b.jsx)(`span`,{className:L.icon,children:`▶`}),(0,b.jsx)(`span`,{className:L.label,children:`运行`})]})}var ze={editorWrapper:`_editorWrapper_o0x3k_5`,codeArea:`_codeArea_o0x3k_13`,bottomBar:`_bottomBar_o0x3k_35`,shortcutHint:`_shortcutHint_o0x3k_45`},Be=n.theme({"&":{fontSize:`18px`,fontFamily:`"Cascadia Code", "Fira Code", "Consolas", "Courier New", monospace`,lineHeight:`1.8`},".cm-content":{padding:`16px`},".cm-gutters":{fontSize:`14px`,borderRight:`1px solid #e0e0e0`,backgroundColor:`#fafafa`,color:`#999`},".cm-activeLineGutter":{backgroundColor:`#e8f5e9`},".cm-activeLine":{backgroundColor:`#f1f8e9 !important`},".cm-cursor":{borderLeftWidth:`2px`}}),Ve=[{label:`print(`,detail:`输出文字`,type:`function`,apply:"print(${})"},{label:`input(`,detail:`让用户输入`,type:`function`,apply:'input("${}")'},{label:`int(`,detail:`转成整数`,type:`function`,apply:"int(${})"},{label:`str(`,detail:`转成字符串`,type:`function`,apply:"str(${})"},{label:`len(`,detail:`数一数有多少`,type:`function`,apply:"len(${})"},{label:`if`,detail:`如果…就…`,type:`keyword`},{label:`elif`,detail:`否则如果…`,type:`keyword`},{label:`else:`,detail:`否则`,type:`keyword`,apply:`else:
    \${}`},{label:`for i in range():`,detail:`重复做N次`,type:`keyword`,apply:"for i in range(${1}):\n    ${2}"},{label:`for item in :`,detail:`遍历列表每一项`,type:`keyword`,apply:"for ${1:item} in ${2:list}:\n    ${3}"},{label:`range(`,detail:`生成数字序列`,type:`function`,apply:"range(${})"},{label:`break`,detail:`跳出循环`,type:`keyword`},{label:`continue`,detail:`跳到下一次循环`,type:`keyword`},{label:`True`,detail:`真`,type:`constant`},{label:`False`,detail:`假`,type:`constant`},{label:`and`,detail:`并且`,type:`keyword`},{label:`or`,detail:`或者`,type:`keyword`},{label:`not`,detail:`不 / 非`,type:`keyword`},{label:`list`,detail:`列表（容器）`,type:`keyword`},{label:`append(`,detail:`往列表里加一个`,type:`function`,apply:".append(${})"},{label:`dict`,detail:`字典（配对）`,type:`keyword`},{label:`def`,detail:`定义函数`,type:`keyword`,apply:"def ${1:name}(${2}):\n    ${3}"},{label:`return`,detail:`返回结果`,type:`keyword`,apply:"return ${}"},{label:`import turtle`,detail:`召唤小海龟画图`,type:`keyword`},{label:`import random`,detail:`随机数模块`,type:`keyword`},{label:`import string`,detail:`字符串工具`,type:`keyword`},{label:`# `,detail:`注释（笔记）`,type:`keyword`}],He=a({override:[e=>{let t=e.matchBefore(/\w*/);return!t||t.from===t.to&&!e.explicit?null:{from:t.from,options:Ve}}]}),Ue=(0,_.forwardRef)(function({value:e,onChange:t,onRun:n,disabled:i,loading:a,autocompleteEnabled:s=!1,children:c},l){let u=(0,_.useRef)(null),d=(0,_.useCallback)(e=>t(e),[t]),f=(0,_.useCallback)(e=>{(e.ctrlKey||e.metaKey)&&e.key===`Enter`&&(e.preventDefault(),n())},[n]);(0,_.useImperativeHandle)(l,()=>({insertTemplate(e){let n=u.current?.view;if(!n)return;let r=n.state.selection.main.head,i=n.state.doc.toString();t(i.slice(0,r)+e+i.slice(r)),n.focus()}}));let p=e.trim().length>0,m=(0,_.useMemo)(()=>s?[o(),Be,He]:[o(),Be],[s]);return(0,b.jsxs)(`div`,{className:ze.editorWrapper,onKeyDown:f,children:[c,(0,b.jsx)(`div`,{className:ze.codeArea,children:(0,b.jsx)(r,{ref:u,value:e,onChange:d,extensions:m,height:`100%`,basicSetup:{lineNumbers:!0,highlightActiveLineGutter:!0,highlightActiveLine:!0,foldGutter:!1,dropCursor:!0,allowMultipleSelections:!1,indentOnInput:!0,bracketMatching:!0,closeBrackets:!0,autocompletion:!1,rectangularSelection:!1,crosshairCursor:!1,highlightSelectionMatches:!0,searchKeymap:!1},theme:`light`,readOnly:i,placeholder:`在这里写 Python 代码…`})}),(0,b.jsxs)(`div`,{className:ze.bottomBar,children:[(0,b.jsx)(Re,{onClick:n,disabled:!p||i,loading:a}),(0,b.jsx)(`span`,{className:ze.shortcutHint,children:`Ctrl+Enter 运行`})]})]})}),We={templatesBar:`_templatesBar_ea5nb_5`,label:`_label_ea5nb_26`,templateList:`_templateList_ea5nb_33`,templateBtn:`_templateBtn_ea5nb_39`,templateEmoji:`_templateEmoji_ea5nb_66`,templateLabel:`_templateLabel_ea5nb_70`},Ge=[{id:`print`,label:`打印`,emoji:`🖨️`,code:`print("你好，世界！")`,description:`用 print() 输出文字`},{id:`input`,label:`输入`,emoji:`⌨️`,code:`name = input("你叫什么名字？")
